...
//Declare a global variable to store integers read from both files for validating.
char* comment;
//Global variables to store the address of read in no-fly zones and flight plans.
